...
ActiveRecord::Schema.define(version: 2021_02_04_160647) do
  ...
  create_table "fake_bookings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["occurence_id"], name: "index_fake_bookings_on_occurence_id"
  end
